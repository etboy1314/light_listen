...
class MusicList {
  ...
  MusicList({num code, Null relatedVideos, Playlist playlist}) {
    this._code = code;
...
class Playlist {
  ...
  set trackNumberUpdateTime(num trackNumberUpdateTime) => _trackNumberUpdateTime = trackNumberUpdateTime;
